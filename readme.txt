...
1.1.8 - Integrated a new Workable API Composer package into the theme, including registration of some global options required for the class (saved as ACF JSON within the theme).
